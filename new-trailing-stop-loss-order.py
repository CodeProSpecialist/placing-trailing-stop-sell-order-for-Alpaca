...
def place_trailing_stop_sell_order(symbol, sell_qty, current_price):
    try:
        ...
        print(f"Placed trailing stop sell order for {sell_qty} shares of {symbol} at {stop_loss_price}")
